...
class AppFixtures extends Fixture
{
    ...
    {
        $array = [
            ['name' => 'Abonnement 1 mois', 'duration' => 1, 'price' => 3],
            ['name' => 'Abonnement 3 mois', 'duration' => 3, 'price' => 8],
            ['name' => 'Abonnement 6 mois', 'duration' => 6, 'price' => 15],
            ['name' => 'Abonnement 1 an', 'duration' => 12, 'price' => 25],
        ];
